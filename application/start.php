...
Autoloader::map(array(
    ...
    //  --  Utilidades para los diferentes modulos
    'UtilidadesAdmin' =>   path('app'). 'libraries/Utilidades/UtilidadesAdmin.php',
    'UtilidadesVentas' =>   path('app'). 'libraries/Utilidades/UtilidadesVentas.php',
    'UtilidadesProduccion' =>   path('app'). 'libraries/Utilidades/UtilidadesProduccion.php',
    'UtilidadesCalidad' =>   path('app'). 'libraries/Utilidades/UtilidadesCalidad.php',
    'UtilidadesCompras' =>   path('app'). 'libraries/Utilidades/UtilidadesCompras.php',

    //  --  Generación de PDF's
    'HTML2PDF' =>   'bundles/laravel-html2pdf/libs/html2pdf.class.php',
));
