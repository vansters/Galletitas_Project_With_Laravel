            ...
            <div class="row-fluid contenedor_tabs span10 offset1">
                ...
                <div class="tabbable tabs-left">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#determinado" data-toggle="tab">
                                <center><h5>Gestión de Reportes</h5></center>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="determinado">
                            ...
                            <div class="row-fluid alert alert-error span11  alertaAgregar">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Instrucciones:</strong> Error al Generar Reporte 
                                <strong>Sin resultados en el Rango de Fechas, Verifíquelo.</strong>
                            </div>
